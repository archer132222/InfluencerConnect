        ...
        return (
          <div className="space-y-4 animate-in slide-in-from-right duration-300">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-xl font-display font-bold">{t("inf.newRequests")}</h2>
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col md:flex-row gap-6 justify-between">
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        <Avatar className="h-12 w-12">
                          <AvatarImage src={`https://images.unsplash.com/photo-${i === 1 ? '1560250097-0b93528c311a' : '1599305445671-ac291c95dddb'}?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80`} />
                          <AvatarFallback>B</AvatarFallback>
                        </Avatar>
                        <div>
                          <h3 className="font-bold text-lg">{i === 1 ? "TechGear Pro" : "FashionNova"}</h3>
                          <p className="text-sm text-gray-400">{i === 1 ? "New Smartphone Launch Review" : "Summer Collection Haul"}</p>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col gap-2 justify-center min-w-[140px]">
                      ...
                      <Button variant="outline" className="w-full border-white/10 hover:bg-white/10 text-white">Decline</Button>
                      <Button variant="ghost" className="w-full text-gray-400 hover:text-white">Message</Button>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        return (
          <div className="space-y-4 animate-in slide-in-from-right duration-300">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-xl font-display font-bold">{t("inf.inProgress")}</h2>
            </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between text-xs text-gray-400">
                    ...
                    <span className="text-white font-medium">Filming in progress</span>
                    <span>Final Review</span>
                  </div>

                  <div className="bg-black/20 p-4 rounded-lg space-y-2">
                    <h4 className="text-sm font-medium text-gray-300">Requirements Checklist</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center gap-2 text-green-400">
                        <CheckCircle2 className="h-4 w-4" />
                        <span className="line-through text-gray-500">Submit Script for Approval</span>
                      </div>
                  ...
                  <Button className="w-full bg-white text-black hover:bg-gray-200">Upload Content</Button>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        return (
          <div className="space-y-4 animate-in slide-in-from-right duration-300">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-xl font-display font-bold">{t("inf.completed")}</h2>
            </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-grow space-y-2">
                      <div className="flex justify-between items-start">
                        ...
                        <Badge className="bg-green-900/30 text-green-400 border-green-900/50">Paid</Badge>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-4 py-2">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-lg text-green-400">$3,200</p>
                        </div>
                      </div>
      ...
      default:
        return (
          <div className="space-y-4 animate-in slide-in-from-left duration-300">
            ...
            <div className="space-y-4">
              <Button onClick={() => setView('new-requests')} variant="secondary" className="w-full h-auto py-4 px-6 justify-between bg-[#2A2A2A] hover:bg-[#333] text-white border-l-4 border-red-500 group rtl:border-l-0 rtl:border-r-4">
                <div className="flex items-center gap-3">
              ...
              <Button onClick={() => setView('completed')} variant="secondary" className="w-full h-auto py-4 px-6 justify-between bg-[#2A2A2A] hover:bg-[#333] text-white border-l-4 border-green-500 group rtl:border-l-0 rtl:border-r-4">
                <div className="flex items-center gap-3">
